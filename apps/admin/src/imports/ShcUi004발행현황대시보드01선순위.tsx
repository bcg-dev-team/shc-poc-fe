import svgPaths from "./svg-nv8txvcn14";
...
function Text12() {
  return (
    <div className="h-[20px] relative shrink-0 w-[20.172px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[20.172px]">
        <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[20px] left-[21px] not-italic text-[#0f172b] text-[14px] text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">3회 완료</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[68.57px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[68.57px]">
        <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[20px] left-[69px] not-italic text-[#00a832] text-[14px] text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">정상 지급 완료</p>
      </div>
    </div>
  );
}
...
function Icon4() {
  return (
    <div className="h-[24px] overflow-clip relative shrink-0 w-full" data-name="Icon">
      ...
      <div className="absolute flex inset-[58.33%_16.67%_8.33%_66.67%] items-center justify-center">
        <div className="flex-none h-[8px] rotate-[180deg] w-[4px]">
      ...
      <div className="absolute bottom-1/4 flex items-center justify-center left-[16.67%] right-[16.67%] top-3/4">
        <div className="flex-none h-px rotate-[180deg] w-[16px]">
          <div className="relative size-full" data-name="Vector">
            <div className="absolute inset-[-1px_-6.25%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 2">
...
function PrimitiveButton() {
  return (
    <div className="bg-white box-border content-stretch flex gap-[6px] items-center justify-center px-[17px] py-[11px] relative rounded-[999px] shrink-0" data-name="Primitive.button">
      ...
      <p className="font-['Pretendard_GOV:SemiBold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-neutral-950 text-nowrap whitespace-pre">Tranche A</p>
    </div>
  );
}
...
function PrimitiveButton1() {
  return (
    <div className="box-border content-stretch flex gap-[6px] items-center justify-center px-[17px] py-[11px] relative rounded-[999px] shrink-0" data-name="Primitive.button">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[999px]" />
      <p className="font-['Pretendard_GOV:Medium',sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-neutral-950 text-nowrap whitespace-pre">Tranche B</p>
    </div>
  );
}
...
function TrancheDetailCard() {
  return (
    <div className="h-[44px] relative shrink-0 w-[859.328px]" data-name="TrancheDetailCard">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex h-[44px] items-start justify-between relative w-[859.328px]">
        <Container19 />
        <Badge2 />
      </div>
    </div>
...
function Paragraph23() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[20px] left-0 not-italic text-[14px] text-neutral-950 text-nowrap top-[-0.5px] whitespace-pre">신한투자증권→ E, 30억, 거래가 30.6억)</p>
    </div>
  );
}
...
export default function ShcUi() {
  return (
    <div className="bg-slate-50 relative size-full" data-name="SHC_UI_004_발행현황대시보드-01선순위">
      <AdminHeader1 />
      <Container5 />
      <MainContent />
    </div>
