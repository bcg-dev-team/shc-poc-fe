import svgPaths from "./svg-o78gbw1ly9";
  ...
  return (
    <div className="relative shrink-0">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[11px] items-center relative">
        <p className="font-['Pretendard_GOV:Bold',sans-serif] leading-[36px] not-italic relative shrink-0 text-[#0f172b] text-[24px] text-nowrap whitespace-pre">강남학동 Tr_A 청약 현황</p>
        <Badge1 />
      </div>
    </div>
  );
...
function StatsCard2() {
  return (
    <div className="absolute content-stretch flex h-[36px] items-start left-[24px] top-[116px] w-[276px]" data-name="StatsCard">
      <p className="basis-0 font-['Pretendard_GOV:SemiBold',sans-serif] grow leading-[36px] min-h-px min-w-px not-italic relative shrink-0 text-[#0f172b] text-[30px]">500억원</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[48.398px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[48.398px]">
        <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[20px] left-[49px] not-italic text-[#0f172b] text-[14px] text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">6.0%</p>
      </div>
    </div>
  );
}
...
function StatsCard10() {
  return (
    <div className="absolute content-stretch flex h-[36px] items-start left-[24px] top-[116px] w-[276px]" data-name="StatsCard">
      <p className="basis-0 font-['Pretendard_GOV:SemiBold',sans-serif] grow leading-[36px] min-h-px min-w-px not-italic relative shrink-0 text-[#0f172b] text-[30px]">15명</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[28.234px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[28.234px]">
        <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[20px] left-[29px] not-italic text-[#0f172b] text-[14px] text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">12명</p>
      </div>
    </div>
  );
}
...
function TableHead() {
  return (
    <div className="bg-blue-50 h-[40px] relative shrink-0 w-[50px]" data-name="TableHead">
...
function TableHead7() {
  return (
    <div className="basis-0 bg-blue-50 grow h-[40px] min-h-px min-w-px relative shrink-0" data-name="TableHead">
      <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[20px] left-[8px] not-italic text-[#0f172b] text-[14px] text-nowrap top-[9.25px] whitespace-pre">상태</p>
    </div>
  );
}
...
function TableHead8() {
  return (
    <div className="bg-blue-50 box-border content-stretch flex gap-[10px] h-full items-center justify-center px-0 py-[9px] relative shrink-0 w-[120px]" data-name="TableHead">
...
function TableCell1() {
  return (
    <div className="basis-0 grow h-[49px] min-h-px min-w-px relative shrink-0" data-name="TableCell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[20px] left-[8px] not-italic text-[#0f172b] text-[14px] text-nowrap top-[14px] whitespace-pre">SUB-001</p>
    </div>
  );
}
...
function Badge3() {
  return (
    <div className="bg-blue-50 relative rounded-[8px] shrink-0" data-name="Badge">
      <div className="box-border content-stretch flex gap-[10px] items-center justify-center overflow-clip px-[9px] py-[3px] relative rounded-[inherit]">
        <p className="font-['Pretendard_GOV:Medium',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#1447e6] text-[12px] text-nowrap whitespace-pre">기관</p>
      </div>
...
function TableCell4() {
  return (
    <div className="basis-0 grow h-[49px] min-h-px min-w-px relative shrink-0" data-name="TableCell">
      <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[20px] left-[79.1px] not-italic text-[#0f172b] text-[14px] text-right top-[14px] translate-x-[-100%] w-[50px]">300억</p>
    </div>
  );
}
...
function TableCell5() {
  return (
    <div className="basis-0 grow h-[49px] min-h-px min-w-px relative shrink-0" data-name="TableCell">
      <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[20px] left-[79.1px] not-italic text-[#007a55] text-[14px] text-right top-[14px] translate-x-[-100%] w-[50px]">300억</p>
    </div>
  );
}
...
function TableCell6() {
  return (
    <div className="basis-0 grow h-[49px] min-h-px min-w-px relative shrink-0" data-name="TableCell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#45556c] text-[14px] text-nowrap top-[14px] whitespace-pre">01-08 09:15</p>
    </div>
  );
}
...
function Badge4() {
  return (
    <div className="absolute bg-[#2a3fec] left-[8px] rounded-[999px] top-[13.5px]" data-name="Badge">
...
function TableCell10() {
  return (
    <div className="basis-0 grow h-[49px] min-h-px min-w-px relative shrink-0" data-name="TableCell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[20px] left-[8px] not-italic text-[#0f172b] text-[14px] text-nowrap top-[14px] whitespace-pre">SUB-002</p>
    </div>
  );
}
...
function TableCell13() {
  return (
    <div className="basis-0 grow h-[49px] min-h-px min-w-px relative shrink-0" data-name="TableCell">
      <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[20px] left-[79.1px] not-italic text-[#0f172b] text-[14px] text-right top-[14px] translate-x-[-100%] w-[50px]">65억</p>
    </div>
  );
}
...
function TableCell14() {
  return (
    <div className="basis-0 grow h-[49px] min-h-px min-w-px relative shrink-0" data-name="TableCell">
      <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[20px] left-[79.1px] not-italic text-[#007a55] text-[14px] text-right top-[14px] translate-x-[-100%] w-[50px]">65억</p>
    </div>
  );
}
...
function TableCell15() {
  return (
    <div className="basis-0 grow h-[49px] min-h-px min-w-px relative shrink-0" data-name="TableCell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#45556c] text-[14px] text-nowrap top-[14px] whitespace-pre">01-08 10:30</p>
    </div>
  );
}
...
function TableCell19() {
  return (
    <div className="basis-0 grow h-[49px] min-h-px min-w-px relative shrink-0" data-name="TableCell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[20px] left-[8px] not-italic text-[#0f172b] text-[14px] text-nowrap top-[14px] whitespace-pre">SUB-003</p>
    </div>
  );
}
...
function TableCell22() {
  return (
    <div className="basis-0 grow h-[49px] min-h-px min-w-px relative shrink-0" data-name="TableCell">
      <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[20px] left-[79.1px] not-italic text-[#0f172b] text-[14px] text-right top-[14px] translate-x-[-100%] w-[50px]">60억</p>
    </div>
  );
}
...
function TableCell23() {
  return (
    <div className="basis-0 grow h-[49px] min-h-px min-w-px relative shrink-0" data-name="TableCell">
      <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[20px] left-[79.1px] not-italic text-[#007a55] text-[14px] text-right top-[14px] translate-x-[-100%] w-[50px]">60억</p>
    </div>
  );
}
...
function TableCell24() {
  return (
    <div className="basis-0 grow h-[49px] min-h-px min-w-px relative shrink-0" data-name="TableCell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#45556c] text-[14px] text-nowrap top-[14px] whitespace-pre">01-08 11:45</p>
    </div>
  );
}
...
function TableCell28() {
  return (
    <div className="basis-0 grow h-[49px] min-h-px min-w-px relative shrink-0" data-name="TableCell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[20px] left-[8px] not-italic text-[#0f172b] text-[14px] text-nowrap top-[14px] whitespace-pre">SUB-004</p>
    </div>
  );
}
...
function TableCell33() {
  return (
    <div className="basis-0 grow h-[49px] min-h-px min-w-px relative shrink-0" data-name="TableCell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#45556c] text-[14px] text-nowrap top-[14px] whitespace-pre">01-09 09:00</p>
    </div>
  );
}
...
function TableCell37() {
  return (
    <div className="basis-0 grow h-[49px] min-h-px min-w-px relative shrink-0" data-name="TableCell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[20px] left-[8px] not-italic text-[#0f172b] text-[14px] text-nowrap top-[14px] whitespace-pre">SUB-005</p>
    </div>
  );
}
...
function TableCell38() {
  return (
    <div className="h-[49px] relative shrink-0 w-[120px]" data-name="TableCell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[20px] left-[8px] not-italic text-[#0f172b] text-[14px] text-nowrap top-[14px] whitespace-pre">롯데자산개발</p>
    </div>
  );
}
...
function TableCell40() {
  return (
    <div className="basis-0 grow h-[49px] min-h-px min-w-px relative shrink-0" data-name="TableCell">
      <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[20px] left-[79.1px] not-italic text-[#0f172b] text-[14px] text-right top-[14px] translate-x-[-100%] w-[50px]">20억</p>
    </div>
  );
}
...
function TableCell41() {
  return (
    <div className="basis-0 grow h-[49px] min-h-px min-w-px relative shrink-0" data-name="TableCell">
      <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[20px] left-[79.1px] not-italic text-[#007a55] text-[14px] text-right top-[14px] translate-x-[-100%] w-[50px]">20억</p>
    </div>
  );
}
...
function TableCell42() {
  return (
    <div className="basis-0 grow h-[49px] min-h-px min-w-px relative shrink-0" data-name="TableCell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#45556c] text-[14px] text-nowrap top-[14px] whitespace-pre">01-09 14:20</p>
    </div>
  );
}
...
function CardContent4() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center relative shrink-0 w-full" data-name="CardContent">
      <SubscriptionTable1 />
      <p className="font-['Pretendard_GOV:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#62748e] text-[14px] text-center text-nowrap whitespace-pre">... 외 10명 (15억 이하 소액 투자자)</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[392.664px]" data-name="CardTitle">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[392.664px]">
        <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[20px] left-0 not-italic text-[20px] text-neutral-950 text-nowrap top-0 whitespace-pre">요약</p>
      </div>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#45556c] text-[14px] text-nowrap top-[-0.5px] whitespace-pre">Tr_A 총계</p>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="h-[28px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[28px] left-0 not-italic text-[#0f172b] text-[16px] top-0 w-[222px]">500억 (15명)</p>
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="h-[28px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[28px] left-0 not-italic text-[#0f172b] text-[16px] top-0 w-[222px]">신한투자증권 300억 (60%)</p>
    </div>
  );
}
...
function Paragraph7() {
  return (
    <div className="h-[28px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[28px] left-0 not-italic text-[#0f172b] text-[16px] top-0 w-[222px]">33.3억</p>
    </div>
  );
}
...
function Card5() {
  return (
    <div className="bg-blue-50 relative rounded-[14px] shrink-0 w-full" data-name="Card">
      <div aria-hidden="true" className="absolute border border-[#c6dfff] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <div className="size-full">
...
function Button7() {
  return (
    <div className="bg-[#2a3fec] box-border content-stretch flex gap-[8px] h-[52px] items-center justify-center px-[31px] py-[8px] relative rounded-[8px] shrink-0 w-[200px]" data-name="Button">
      <Icon11 />
...
export default function ShcUi002TrA() {
  return (
    <div className="bg-slate-50 relative size-full" data-name="SHC_UI_002_청약관리_TrA 1">
      <AdminHeader1 />
      <Container6 />
      <MainContent />
    </div>
