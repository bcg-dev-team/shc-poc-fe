import svgPaths from "./svg-0qba8oyvka";
...
function Badge3() {
  return (
    <div className="bg-blue-50 h-[22px] relative rounded-[8px] shrink-0 w-[38.742px]" data-name="Badge">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[4px] h-[22px] items-center justify-center overflow-clip px-[9px] py-[3px] relative rounded-[inherit] w-[38.742px]">
        <p className="font-['Pretendard_GOV:Medium',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#1447e6] text-[12px] text-nowrap whitespace-pre">활발</p>
      </div>
...
function StatsCard13() {
  return (
    <div className="absolute h-[20px] left-[24px] top-[88px] w-[276px]" data-name="StatsCard">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#62748e] text-[14px] text-nowrap top-[-0.5px] whitespace-pre">P2P 거래량</p>
    </div>
  );
}
...
function StatsCard14() {
  return (
    <div className="absolute content-stretch flex h-[36px] items-start left-[24px] top-[116px] w-[276px]" data-name="StatsCard">
      <p className="basis-0 font-['Pretendard_GOV:SemiBold',sans-serif] grow leading-[36px] min-h-px min-w-px not-italic relative shrink-0 text-[#0f172b] text-[30px]">104억원</p>
    </div>
  );
}
...
function Text15() {
  return (
    <div className="h-[20px] relative shrink-0 w-[52.438px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[52.438px]">
        <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#45556c] text-[14px] text-nowrap top-[-0.5px] whitespace-pre">거래 건수</p>
      </div>
    </div>
  );
}
...
function Text16() {
  return (
    <div className="h-[20px] relative shrink-0 w-[20.172px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[20.172px]">
        <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[20px] left-0 not-italic text-[#0f172b] text-[14px] text-nowrap top-[-0.5px] whitespace-pre">3건</p>
      </div>
    </div>
  );
}
...
function Text17() {
  return (
    <div className="h-[20px] relative shrink-0 w-[64.531px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[64.531px]">
        <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#45556c] text-[14px] text-nowrap top-[-0.5px] whitespace-pre">평균 거래가</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[36.727px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[36.727px]">
        <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[20px] left-0 not-italic text-[#0f172b] text-[14px] text-nowrap top-[-0.5px] whitespace-pre">102%</p>
      </div>
    </div>
  );
}
...
function PrimitiveButton() {
  return (
    <div className="box-border content-stretch flex gap-[6px] items-center justify-center px-[17px] py-[11px] relative rounded-[999px] shrink-0" data-name="Primitive.button">
      ...
      <p className="font-['Pretendard_GOV:Medium',sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-neutral-950 text-nowrap whitespace-pre">Tranche A</p>
    </div>
  );
}
...
function PrimitiveButton1() {
  return (
    <div className="bg-white box-border content-stretch flex gap-[6px] items-center justify-center px-[17px] py-[11px] relative rounded-[999px] shrink-0" data-name="Primitive.button">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[999px]" />
      <p className="font-['Pretendard_GOV:SemiBold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-neutral-950 text-nowrap whitespace-pre">Tranche B</p>
    </div>
  );
}
...
function PrimitiveButton2() {
  return (
    <div className="box-border content-stretch flex gap-[6px] items-center justify-center px-[17px] py-[11px] relative rounded-[999px] shrink-0" data-name="Primitive.button">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[999px]" />
      <p className="font-['Pretendard_GOV:Medium',sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-neutral-950 text-nowrap whitespace-pre">통합 조회</p>
    </div>
  );
}
...
function TrancheDetailCard() {
  return (
    <div className="h-[44px] relative shrink-0 w-[859.328px]" data-name="TrancheDetailCard">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex h-[44px] items-center justify-between relative w-[859.328px]">
        <Container19 />
        <Badge4 />
      </div>
    </div>
...
function TrancheDetailCard1() {
  return (
    <div className="relative shrink-0 w-[859.328px]" data-name="TrancheDetailCard">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col gap-[24px] items-start relative w-[859.328px]">
        <Container25 />
        <Container31 />
        <Container41 />
      </div>
...
function Card4() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-[30px] items-start pl-[25px] pr-px py-[25px] relative rounded-[14px] shrink-0 w-[909.328px]" data-name="Card">
      <div aria-hidden="true" className="absolute border border-slate-200 border-solid inset-0 pointer-events-none rounded-[14px]" />
      <TrancheDetailCard />
      <TrancheDetailCard1 />
    </div>
...
function ActivityLog1() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-[392.664px]" data-name="ActivityLog">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col gap-[12px] h-full items-start relative w-[392.664px]">
        <Container45 />
        <Container49 />
        <Container53 />
      </div>
...
function Card5() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-[30px] h-[454px] items-start pl-[25px] pr-px py-[25px] relative rounded-[14px] shrink-0 w-[442.664px]" data-name="Card">
      <div aria-hidden="true" className="absolute border border-slate-200 border-solid inset-0 pointer-events-none rounded-[14px]" />
      <ActivityLog />
      <ActivityLog1 />
    </div>
...
function App() {
  return (
    <div className="relative shrink-0" data-name="App">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[24px] items-start relative">
        <Card4 />
        <Card5 />
      </div>
    </div>
...
export default function ShcUi() {
  return (
    <div className="bg-slate-50 relative size-full" data-name="SHC_UI_004_발행현황대시보드-02후순위">
      <AdminHeader1 />
      <Container5 />
      <MainContent />
    </div>
