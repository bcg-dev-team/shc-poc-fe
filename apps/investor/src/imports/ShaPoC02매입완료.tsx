import svgPaths from "./svg-pqe890hjkm";
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center not-italic relative shrink-0 text-center w-full">
      <p className="font-['Spoqa_Han_Sans_Neo:Bold',sans-serif] leading-[28px] min-w-full relative shrink-0 text-[#111111] text-[20px] tracking-[-0.5px] w-[min-content]">매입이 완료되었어요</p>
      <p className="font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] leading-[20px] relative shrink-0 text-[#999ea4] text-[14px] text-nowrap whitespace-pre">토큰은 익일 09:00에 발행돼요</p>
    </div>
  );
}
...
function Text() {
  return (
    <div className="font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[20px] not-italic place-items-start relative shrink-0 text-nowrap whitespace-pre" data-name="text">
      ...
      <p className="[grid-area:1_/_1] ml-[320px] mt-0 relative text-[#333950] text-[14px] text-right translate-x-[-100%]">SHA202511160001</p>
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      <p className="font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#333950] text-[14px] text-nowrap text-right whitespace-pre">2025.11.16 14:20:33</p>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[20px] not-italic place-items-start relative shrink-0 text-nowrap whitespace-pre" data-name="text">
      <p className="[grid-area:1_/_1] ml-0 mt-0 relative text-[#777e8c] text-[13px]">매입 금액</p>
...
function Text5() {
  return (
    <div className="font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[20px] not-italic place-items-start relative shrink-0 text-nowrap whitespace-pre" data-name="text">
      <p className="[grid-area:1_/_1] ml-0 mt-0 relative text-[#777e8c] text-[13px]">발행 예정 토큰</p>
...
function Text6() {
  return (
    <div className="font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[20px] not-italic place-items-start relative shrink-0 text-nowrap whitespace-pre" data-name="text">
      <p className="[grid-area:1_/_1] ml-0 mt-0 relative text-[#777e8c] text-[13px]">발행 예정일</p>
      <p className="[grid-area:1_/_1] ml-[320px] mt-0 relative text-[#333950] text-[14px] text-right translate-x-[-100%]">2025.11.17 (익일)</p>
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      <p className="font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#333950] text-[14px] text-nowrap text-right whitespace-pre">오전 9:00 (예정)</p>
    </div>
  );
}
...
function Text7() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0 w-full" data-name="text">
      <p className="[grid-area:1_/_1] font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] leading-[20px] ml-[0.46px] mt-0 not-italic relative text-[#777e8c] text-[13px] w-[197.467px]">발행 시간</p>
      <Frame17 />
    </div>
  );
}
...
function Frame18() {
  return <div className="h-[20px] shrink-0 w-[97px]" />;
}
...
function Text8() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0 w-full" data-name="text">
      <p className="[grid-area:1_/_1] font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] leading-[20px] ml-[0.46px] mt-0 not-italic relative text-[#999999] text-[11px] w-[197.467px]">* NAV 업데이트와 동시 발행</p>
      <Frame19 />
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
      <p className="font-['Spoqa_Han_Sans_Neo:Bold',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#111111] text-[16px] w-full">토큰 발행 안내</p>
      <Frame22 />
      <Frame6 />
    </div>
  );
...
function BtnMainN({ onClick }: { onClick: () => void }) {
  return (
    ...
    >
      ...
      <p className="absolute font-['Spoqa_Han_Sans_Neo:Medium',sans-serif] inset-[26.92%_6.25%] leading-[24px] not-italic text-[16px] text-center text-white">보유 자산 확인</p>
    </button>
  );
}
